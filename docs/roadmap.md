...
- [ ] **ชิ้นสุดท้าย: ย้าย listener ไปเครื่องที่เปิด 24 ชม.** — คอมข้าง DVR (ถ้าเปิดตลอด) หรือ Mini PC N100 ~3,000฿ (= ต้นแบบกล่อง Tassana ส่งลูกค้า); ใช้ `install-autostart.ps1`; ตอนนี้โน้ตบุ๊กเป็นสะพานชั่วคราวเฉพาะวันที่อยู่ออฟฟิศ
