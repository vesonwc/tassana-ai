...
- **ตรวจภาพจริงย้อนหลังทั้ง 5 ใบ (2026-08-19) — เจ้าของยืนยันว่าไม่มีคนจริง:** 02:49 ลานจอด = **สุนัข 1 ตัว** ถูกเรียกว่า "บุคคล", 04:57 ช่อง 7 = **ห้องว่างเปล่า** ถูกเรียกว่า "บุคคลต้องสงสัย", อีก 2 ใบมีเงาคล้ายคนแต่ยืนยันไม่ได้ → **2 ใน 5 เป็นการตีความผิดของ VLM ไม่ใช่เรื่องคนคุ้นเคย**
- แก้ความรู้ที่ผมใส่ผิด (อนุมานจากคำบรรยายที่ผิดเอง): ลบ "พนักงานเข้าตี 5 / ทำงานถึงเที่ยงคืน" → ใส่ข้อเท็จจริงจริง: **เข้างาน ~07:00 หลังเวลาทำการออฟฟิศควรว่าง** และ **กลางคืนมีสุนัข/แมวจรเดินผ่านลานจอดเป็นประจำ**
- แก้ที่ต้นเหตุ: prompt เพิ่มกติกาเฉพาะภาพกลางคืน (19:00-07:00) — ห้ามระบุว่า "คน" ถ้าไม่เห็นรูปทรงมนุษย์ชัด (หัว/ลำตัว/แขนขา) ให้บรรยายตามจริงและตั้ง uncertain=true ถามผู้ดูแลแทน; และคำใบ้จาก detector จะบอกออกมาตรง ๆ เมื่อความมั่นใจ < 0.5 ว่า "อาจเป็นสัตว์ เงา หรือวัตถุอื่น"
